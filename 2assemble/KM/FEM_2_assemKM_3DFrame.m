...
%--------------------------------------------------------------------------
function [rowK, colK,valK,valM] = FEM_2_assemKM_3DFrame (in_data,dofN,ndPerElem)
...
for i=1:sxEL
    ...
    rho= in_data.EL(i,9);
    nu = in_data.EL(i,10);
    [M_loc,Klc] = FEM_ELEMENT_3DBEAM(in_data.ND(node1,2),in_data.ND(node1,3),in_data.ND(node1,4), ...
        in_data.ND(node2,2),in_data.ND(node2,3),in_data.ND(node2,4),E,G,b,ho,rho,nu);
